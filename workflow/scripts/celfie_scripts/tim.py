...
if __name__ == "__main__":
    ...
    # input_file = "/Users/ireneu/berman_lab/celfie/TIMs/grail_alpha_beta.bedgraph" # input bedfile of WGBS data
    # output_file = "/Users/ireneu/berman_lab/celfie/alpha_beta_grail_tims.txt"  # path to output file
    # num_values = 200  # number of values to keep as tims
    # tissues = 2  # total number of tissues to calc tims for
    # depth_filter = 1# depth filter
    # nan_filter = 1  # number of nans to allow in TIM calc
