...
#IU: altered to accept command line arguments

while getopts i:o:s:w:n:t:d:e: flag
do
    case "${flag}" in
        i) input_file=${OPTARG};;
        o) output_file=${OPTARG};;
        s) summed_file=${OPTARG};;
        w) sum_window_size=${OPTARG};;
        n) number_tims=${OPTARG};;
        t) number_tissues=${OPTARG};;
...
#input_file='/Users/ireneu/berman_lab/celfie/celfie_upenn.bedgraph'
#output_file=grail_alpha_beta_tims.txt
#summed_file=grail_alpha_beta_tims_summed.txt
#sum_window_size=500
#number_tims=100
#number_tissues=2
#depth_filter=15
